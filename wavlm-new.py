...
wav2vec2_processor = Wav2Vec2Processor.from_pretrained("/home/yangziheng/TalkingGaussian-may/WavLm/wav2vec2")
print("Loading the WavLM Model...")
wavlm_model = WavLMModel.from_pretrained("/home/yangziheng/TalkingGaussian-may/WavLm")
...
@torch.no_grad()
def get_wavlm_from_16k_speech(speech, device="cuda:1"):
    global wavlm_model
